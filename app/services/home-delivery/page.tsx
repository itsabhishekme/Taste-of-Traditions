...
const deliveryServices = [
  {
    ...
    description:
      "Freshly prepared Indian cuisine delivered quickly to your doorstep with premium packaging.",
    image:
      "https://images.unsplash.com/photo-1526367790999-0150786686a2?q=80&w=1400&auto=format&fit=crop",
  },

  {
    ...
    description:
      "Every order is securely packed to preserve freshness, taste, and food quality during delivery.",
    image:
      "https://images.unsplash.com/photo-1586190848861-99aa4a171e90?q=80&w=1400&auto=format&fit=crop",
  },

  {
    ...
    description:
      "Enjoy authentic Indian dining experiences from the comfort of your home with premium presentation.",
    image:
...
const features = [
...

  {
    ...
    image:
      "https://images.unsplash.com/photo-1520201163981-8cc95007dd2e?q=80&w=1200&auto=format&fit=crop",
  },
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-28">
          ...
          <p className="mt-8 max-w-3xl text-lg md:text-xl text-gray-400 leading-relaxed">
            ...
            Bringing authentic Indian flavors directly to your home with
            fast delivery, premium packaging, and unforgettable dining
            experiences crafted with passion and tradition.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="text-center mb-20">
            ...
            <p className="mt-6 max-w-3xl mx-auto text-lg text-gray-400 leading-relaxed">
              ...
              Enjoy luxury Indian dining experiences delivered safely,
              quickly, and beautifully packaged to your doorstep.
            </p>
          </div>
          ...
          <div className="relative overflow-hidden rounded-[40px] border border-white/10 bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-2xl p-10 md:p-16">
            ...
            <div className="relative text-center">
              ...
              <p className="mt-6 max-w-3xl mx-auto text-lg text-gray-400 leading-relaxed">
                ...
                Taste of Traditions combines speed, freshness, luxury
                presentation, and authentic Indian cuisine into one
                unforgettable home dining experience.
              </p>
            </div>
